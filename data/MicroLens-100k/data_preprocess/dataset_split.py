...
if __name__ == '__main__':
    initial_data_list = pd.read_pickle(r'./data.pkl')  # 리스트임
    initial_data_frame = pd.DataFrame(initial_data_list)  # 리스트 → DataFrame 변환
    ...
    train_data_frame.to_pickle(r'./data/MicroLens-100k/train.pkl')
    test_data_frame.to_pickle(r'./data/MicroLens-100k/test.pkl')
    valid_data_frame.to_pickle(r'./data/MicroLens-100k/valid.pkl')